...
<div class="jumbotron text-center">
    <h3 class="display-9">Add Faculty</h3>
</div>
        ...
        <div class="row">
            <div class="col-sm-10" style="margin-left:auto;margin-right: auto;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" pattern="[T,0-9]{5}" required  name="faculty_id" id="faculty_id" placeholder="Enter name">
            ...
            <div>
                ...
                <button type="submit" class="btn btn-warning" style="text-color:black;"><a href="Facultylist.jsp">Cancel</button>
            </div>
        </div>
         </div>
